/*
 * Vparse.c: Parse parameters by substring
 *	
 *
...
int    *ac;
char  ***av;
VisXparam_t *parm;		/* terminated by  match == 0  */
...
/*
 *  Vparse2 does the matching of the string. Now it
